    ...
    {{
        ...
        "steps": [
            {{
                ...
                "emotional_disturbance": boolean (true or false),
                "recommended_step_to_swift_to": "Step index (Make a decision based on the Decision Rules and provide an explanation)"
            }}
        ]
    }}
    ]
