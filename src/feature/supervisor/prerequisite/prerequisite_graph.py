...
from src.feature.supervisor.prerequisite.prompt.prerequisite_1_1_en_prompt import \
    PREREQUISITE_PROMPT_1_1_TREATMENT_FRAMEWORK
from src.feature.supervisor.prerequisite.prompt.prerequisite_1_2_en_prompt import \
